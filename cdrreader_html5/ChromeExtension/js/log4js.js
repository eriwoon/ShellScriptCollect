 ...
 * @param level The priority level of this log event
 */
//Log.writeLogger = function(msg,level) { docum ent.writeln(level+"&nbsp;-&nbsp;"+msg+"<br/>"); }
...
Log.remoteLogger = function(msg,level,obj) {
  var d = new Date();
  var h = d.getHours();
  if (h<10) { h="0"+h; }
  var m = d.getMinutes();
  ...
  $.ajax({
    type: "post",
    url: "http://nodejsdashboard-eriwoon-2.c9.io/log/",
    data: JSON.stringify(data),
    contentType: "application/json; charset=utf-8",
    dataType:"json",
    success: function(){},
    error: function(msg){alert("remoteLogger:" + msg);}
  });
}
/**
